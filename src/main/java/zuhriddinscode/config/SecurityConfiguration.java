...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                //cors ni o'chirish (barcha domenlardan so'rovlarga ruxsat berish)
                ...
                // nastroyki dostupa konechnim tochkam

                .authorizeHttpRequests
                // malum bir yolni belgilash m-n. * - joylashtirish darajasi, ** - joylashtirish darajalarning istalgan soni
